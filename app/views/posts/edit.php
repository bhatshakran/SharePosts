...
<a href="<?php echo URLROOT; ?>/posts" class="btn btn-light"><i
...
<div class="card card-body bg-light mt-5">
    ...
    <form action="<?php echo URLROOT; ?>/posts/edit/<?php echo $data['id']; ?>"
        ...
        <div class="form-group">
            ...
            <span
                class="invalid-feedback"><?php echo $data['title_err']; ?></span>
        </div>
        <div class="form-group">
            ...
            <span
                class="invalid-feedback"><?php echo $data['body_err']; ?></span>
        </div>
